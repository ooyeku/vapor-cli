...
mod tests {
    ...
    fn test_vapor_db_execute() {
        ...
        vapor_db
            ...
            .unwrap();
        vapor_db
            .execute("INSERT INTO test (name) VALUES ('test_value')")
            .unwrap();
    ...
    fn test_vapor_db_transactions() {
        ...
        vapor_db
            .execute("INSERT INTO test (name) VALUES ('test_transaction')")
            .unwrap();
    ...
    fn test_vapor_db_export_methods() {
        ...
        let vapor_db = VaporDB::create(db_path).unwrap();
        vapor_db
            .execute("CREATE TABLE export_methods_test (id INTEGER PRIMARY KEY, name TEXT)")
            .unwrap();
        vapor_db
            .execute("INSERT INTO export_methods_test (name) VALUES ('method1'), ('method2')")
            .unwrap();
        ...
        vapor_db
            .export_to_csv("export_methods_test", csv_path1)
            .unwrap();
        ...
        vapor_db
            .export_query_to_csv(
                "SELECT name FROM export_methods_test WHERE name = 'method2'",
                csv_path2,
            )
            .unwrap();
    ...
    fn test_vapor_db_with_options() {
        ...
        let vapor_db = VaporDB::create(db_path).unwrap();
        vapor_db
            .execute("CREATE TABLE options_test (id INTEGER PRIMARY KEY, data TEXT)")
            .unwrap();
        vapor_db
            .execute("INSERT INTO options_test (data) VALUES ('test1'), ('test2'), ('test3')")
            .unwrap();
    ...
    fn test_transaction_rollback() {
        ...
        let vapor_db = VaporDB::create(db_path).unwrap();
        vapor_db
            .execute("CREATE TABLE rollback_test (id INTEGER PRIMARY KEY, name TEXT)")
            .unwrap();
        vapor_db
            .execute("INSERT INTO rollback_test (name) VALUES ('initial')")
            .unwrap();

        // Begin transaction and insert data
        vapor_db.begin_transaction().unwrap();
        vapor_db
            .execute("INSERT INTO rollback_test (name) VALUES ('transactional')")
            .unwrap();
    ...
    fn test_data_types_and_distributions() {
        ...
        let _normal = DataDistribution::Normal {
            mean: 50.0,
            std_dev: 10.0,
        };
    ...
    fn test_integration_workflow() {
        ...
        // 1. Create schema
        vapor_db
            .execute("CREATE TABLE workflow_test (id INTEGER PRIMARY KEY, name TEXT, score REAL)")
            .unwrap();

        // 2. Insert data with transaction
        vapor_db.begin_transaction().unwrap();
        vapor_db
            .execute("INSERT INTO workflow_test (name, score) VALUES ('Alice', 95.5)")
            .unwrap();
        vapor_db
            .execute("INSERT INTO workflow_test (name, score) VALUES ('Bob', 87.2)")
            .unwrap();
        vapor_db.commit_transaction().unwrap();
